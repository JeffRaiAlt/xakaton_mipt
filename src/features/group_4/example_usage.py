...
from src.features.group_4.feature_processor import FeatureProcessor
...
def main() -> None:
    ...
    processors = [
        FeatureProcessor(
            ...
            feature_names_path=project_root / "data" / "feature_groups" / "features_group_4.txt",
            group_name="group_4",
            owner="member_4",
            specs_json_path=project_root / "src" / "features" / "group_4" / "example_feature_spec.json",
        ),
    ]
