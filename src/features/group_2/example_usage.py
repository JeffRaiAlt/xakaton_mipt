...
from src.features.group_2.feature_processor import FeatureProcessor
...
def main() -> None:
    ...
    processors = [
        FeatureProcessor(
            ...
            feature_names_path=project_root / "data" / "feature_groups" / "features_group_2.txt",
            group_name="group_2",
            owner="member_2",
            specs_json_path=project_root / "src" / "features" / "group_2" / "example_feature_spec.json",
        ),
    ]
