...
from src.features.group_1.feature_processor import FeatureProcessor
...
def main() -> None:
    ...
    processors = [
        FeatureProcessor(
            ...
            feature_names_path=project_root / "data" / "feature_groups" / "features_group_1.txt",
            group_name="group_1",
            owner="member_1",
            specs_json_path=project_root / "src" / "features" / "group_1" / "example_feature_spec.json",
        ),
    ]
