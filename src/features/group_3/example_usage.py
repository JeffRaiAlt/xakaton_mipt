...
from src.features.group_3.feature_processor import FeatureProcessor
...
def main() -> None:
    ...
    processors = [
        FeatureProcessor(
            ...
            feature_names_path=project_root / "data" / "feature_groups" / "features_group_3.txt",
            group_name="group_3",
            owner="member_3",
            specs_json_path=project_root / "src" / "features" / "group_3" / "example_feature_spec.json",
        ),
    ]
