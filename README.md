# 📦 Модель прогнозирования выкупа.

## 📖 Описание

Требуется модель машинного обучения, которая сможет предсказывать
вероятность выкупа заказа непосредственно в день его оформления. 
Это позволит компании своевременно реагировать на заказы с низким 
шансом выкупа, оптимизировать процессы и снизить убытки.
...
- анализ FP ошибок (экспериментально)
